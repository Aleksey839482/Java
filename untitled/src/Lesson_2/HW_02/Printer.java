...
class BubbleSort {
    ...
    public static void sort(int[] mas) {
        try {
            log = new File("untitled/src/Lesson_2/HW_02/log.txt");
            log.createNewFile();
...
public class Printer{
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("untitled/src/Lesson_2/HW_02/log.txt"))) {
            String line;
